...
-- ============================================================
-- 7 Users (+ pharmacy department resolver note: Ravi has no
-- matching hierarchy_levels.department row on purpose — see
-- entry_point_resolver.py fallback-to-root behavior)
-- ============================================================
-- HODs (Vikram, Sharma) are seeded with MNPI clearance: an HOD is expected
-- to see their own department's confidential strategic/budget decisions
-- (e.g. N-O11) while still being blocked from ADMIN-only CONFIDENTIAL
-- content (e.g. N-O12, which additionally requires CONFIDENTIAL clearance)
...
('U-VIKRAM', 'supra', 'Dr. Vikram (HOD)',   'HOD',     'ortho',      4, 4,    '{"MNPI"}'),
('U-ANANYA', 'supra', 'Dr. Ananya',         'EDITOR',  'medicine',   8, 8,    '{}'),
('U-SHARMA', 'supra', 'Dr. Sharma (HOD)',   'HOD',     'medicine',   4, 4,    '{"MNPI"}'),
...
-- ============================================================
-- Mark N-M08 as superseded_by N-M02 (Check 4 also relies on
-- status = 'SUPERSEDED', this FK link is for traceability)
-- ============================================================
